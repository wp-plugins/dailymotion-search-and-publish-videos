...
<div id="category_source">
    ...
    <?php settings_fields( 'ocv_settings-group-youtube' ); ?>
    <?php do_settings_sections( 'ocv_settings-group-youtube' ); 
	$selected="";?>
	...
	<h3>Your Videos will be posted to the following categories</h3>
		<input type="hidden" id="youtube_parent_cat_id_hidden" name="youtube_parent_cat_id_hidden" value="<?php echo get_option( 'youtube_parent_cat_id_hidden' ); ?>">
		Main Category:<input type="text" id="parent_cat_name" value="<?php  echo get_cat_name( get_option( 'youtube_parent_cat_id_hidden' ) ); ?>" readonly>
		<input type="hidden" id="youtube_child_cat_id_hidden"  name="youtube_child_cat_id_hidden" value="<?php echo get_option( 'youtube_child_cat_id_hidden' ); ?>">
		Sub Category<input type="text" id="child_cat_name" value="<?php  echo get_cat_name( get_option( 'youtube_child_cat_id_hidden' ) ); ?>" readonly>
		<input type="hidden" id="youtube_subchild_cat_id_hidden" name="youtube_subchild_cat_id_hidden" value="<?php echo get_option( 'youtube_subchild_cat_id_hidden' ); ?>">
		Sub Sub Category<input type="text" id="subchild_cat_name" value="<?php  echo get_cat_name( get_option( 'youtube_subchild_cat_id_hidden' ) ); ?>" readonly>
